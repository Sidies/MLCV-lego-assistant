...
#
COPY jetson-inference/python/training/detection/ssd/requirements.txt /tmp/pytorch_ssd_requirements.txt
COPY jetson-inference/python/www/flask/requirements.txt /tmp/flask_requirements.txt
COPY jetson-inference/python/www/dash/requirements.txt /tmp/dash_requirements.txt
...
COPY jetson-inference/docker/containers/scripts/opencv_install.sh /tmp/opencv_install.sh
