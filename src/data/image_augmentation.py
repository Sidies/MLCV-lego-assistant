...
def to_trainvaltest(pics, labels,val_test_size,val_size):
    ...
    X_train, X_valtest, y_train, y_valtest = train_test_split(pics, labels,test_size=val_test_size, shuffle = True, random_state = 8)
...
def getTransformFunction(lossOfInfo=False,onlyResize=False,width=300,height=300):
